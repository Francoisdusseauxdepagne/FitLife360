 ...
 */
final class Version20240703075826 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profile_coach DROP lieu');
        $this->addSql('ALTER TABLE session_coaching DROP FOREIGN KEY FK_411268A63C105691');
        $this->addSql('DROP INDEX IDX_411268A63C105691 ON session_coaching');
        $this->addSql('ALTER TABLE session_coaching ADD lieu VARCHAR(255) DEFAULT NULL, CHANGE coach_id profile_coach_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profile_coach ADD lieu VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE session_coaching DROP lieu, CHANGE profile_coach_id coach_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_411268A63C105691 ON session_coaching (coach_id)');
    }
}
